/*
[version 2019] check & update by everlasting
...
"如果C程序中使用了math.h中的函数，在编译时需要加入选项",
"Linux系统中具有最高权限的用户是",
...
"在NOI系列考试中，如果由于文件名不正确导致被判0分，提出复评请求，会被接受吗",
"在NOI系列考试中，如果由于文件目录名不正确导致被判0分，提出复评请求，会被接受吗",
"在NOI系列考试中，如果由于文件保存路径不正确导致被判0分，提出复评请求，会被接受吗",
...
"今年是第几届IOI",
"第12届IOI是哪一年在北京举办的",
"对评测结果中的超时有异议，且复测结果的运行时间与题目时间限制之差小于题目时间限制5％的申诉是否会被受理",
"在NOI上机考试中，是否允许选手私自重新启动计算机"
};
